...
namespace TheTracker.Controllers
{
    public class TicketHistoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,TicketId,Property,Description,Created,OldValue,NewValue,UserId")] TicketHistory ticketHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,TicketId,Property,Description,Created,OldValue,NewValue,UserId")] TicketHistory ticketHistory)
        {
