...
namespace TheTracker.Controllers
{
    public class TicketAttachmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,Created,TicketId,UserId,TicketFileData,TicketFileType,TicketFileName,TicketContentType")] TicketAttachment ticketAttachment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Description,Created,TicketId,UserId,TicketFileData,TicketFileType,TicketFileName,TicketContentType")] TicketAttachment ticketAttachment)
        {
