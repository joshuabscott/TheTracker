...
namespace TheTracker.Controllers
{
    public class InvitesController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["InviterId"] = new SelectList(_context.Users, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,InviteDate,JoinDate,CompanyToken,CompanyId,ProjectId,InviterId,InviteeId,InviteeEmail,InviteeFirstName,InviteeLastName,Message,IsValid")] Invite invite)
        {
            ...
            ViewData["CompanyId"] = new SelectList(_context.Companies, "Id", "CompanyName", invite.CompanyId);
            ViewData["InviteeId"] = new SelectList(_context.Users, "Id", "Id", invite.InviteeId);
            ViewData["InviterId"] = new SelectList(_context.Users, "Id", "Id", invite.InviterId);
