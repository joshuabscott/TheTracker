...
namespace TheTracker.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,CompanyId,Name,Description,Created,StartDate,EndDate,ProjectPriorityId,Archived,ProjectFileData,ProjectFileType,ImageContentType")] Project project)
        {
            if (id != project.Id)
            {
                return NotFound();
