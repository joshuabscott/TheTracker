...
namespace TheTracker.Data
{
    public static class DataUtility
    {
        ...
        public static async Task SeedDefaultCompaniesAsync(ApplicationDbContext context)
        {
            try
            {
                IList<Company> defaultcompanies = new List<Company>() {
                    ...
                    new Company() { CompanyName = "Company3", Description="This is default Company 3" },
                    new Company() { CompanyName = "Company4", Description="This is default Company 4" },
                    new Company() { CompanyName = "Company5", Description="This is default Company 5" }
                };
        ...
        public static async Task SeedDefaultProjectPriorityAsync(ApplicationDbContext context)
        {
            try
            {
                IList<Models.ProjectPriority> projectPriorities = new List<ProjectPriority>() {
                                                    new ProjectPriority() { Name = TTProjectPriority.Low.ToString() },
                                                    new ProjectPriority() { Name = TTProjectPriority.Medium.ToString() },
                                                    new ProjectPriority() { Name = TTProjectPriority.High.ToString() },
                                                    new ProjectPriority() { Name = TTProjectPriority.Urgent.ToString() },
                };
        ...
        public static async Task SeedDefautProjectsAsync(ApplicationDbContext context)
        {
            ...
            int priorityLow = context.ProjectPriorities.FirstOrDefault(p => p.Name == TTProjectPriority.Low.ToString()).Id;
            int priorityMedium = context.ProjectPriorities.FirstOrDefault(p => p.Name == TTProjectPriority.Medium.ToString()).Id;
            int priorityHigh = context.ProjectPriorities.FirstOrDefault(p => p.Name == TTProjectPriority.High.ToString()).Id;
            int priorityUrgent = context.ProjectPriorities.FirstOrDefault(p => p.Name == TTProjectPriority.Urgent.ToString()).Id;
            ...
            try
            {
                IList<Project> projects = new List<Project>() {
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2020,1,16),
                         EndDate = new DateTime(2020,2,20).AddMonths(1),
                     ...
                     new Project()
                     {
                         ...
                         EndDate = new DateTime(2020,6,27).AddMonths(4),
                     ...
                     new Project()
                     {
                         ...
                         StartDate = new DateTime(2022,8,17),
                         EndDate = new DateTime(2022,12,30).AddMonths(6),
                     ...
                     new Project()
                     {
                         ...
                         EndDate = new DateTime(2022,8,22).AddMonths(2),
                         ProjectPriorityId = priorityLow
                     },
                    new Project()
                     {
                         ...
                         EndDate = new DateTime(2021,10,21).AddMonths(3),
                         ProjectPriorityId = priorityHigh
                     }
                };
        ...
        public static async Task SeedDemoUsersAsync(UserManager<TTUser> userManager)
        {
        ...
        public static async Task SeedDefaultTicketTypeAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketType> ticketTypes = new List<TicketType>() {
                     new TicketType() { Name = TTTicketType.NewDevelopment.ToString() },      // Ticket involves development of a new, uncoded solution 
                     new TicketType() { Name = TTTicketType.WorkTask.ToString() },            // Ticket involves development of the specific ticket description 
                     new TicketType() { Name = TTTicketType.Defect.ToString()},               // Ticket involves unexpected development/maintenance on a previously designed feature/functionality
                     new TicketType() { Name = TTTicketType.ChangeRequest.ToString() },       // Ticket involves modification development of a previously designed feature/functionality
                     new TicketType() { Name = TTTicketType.Enhancement.ToString() },         // Ticket involves additional development on a previously designed feature or new functionality
                     new TicketType() { Name = TTTicketType.GeneralTask.ToString() }          // Ticket involves no software development but may involve tasks such as configurations, or hardware setup
                };
        ...
        public static async Task SeedDefaultTicketStatusAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketStatus> ticketStatuses = new List<TicketStatus>() {
                    new TicketStatus() { Name = TTTicketStatus.New.ToString() },                 // Newly Created ticket having never been assigned
                    new TicketStatus() { Name = TTTicketStatus.Development.ToString() },         // Ticket is assigned and currently being worked 
                    new TicketStatus() { Name = TTTicketStatus.Testing.ToString()  },            // Ticket is assigned and is currently being tested
                    new TicketStatus() { Name = TTTicketStatus.Resolved.ToString()  },           // Ticket remains assigned to the developer but work in now complete
                };
        ...
        public static async Task SeedDefaultTicketPriorityAsync(ApplicationDbContext context)
        {
            try
            {
                IList<TicketPriority> ticketPriorities = new List<TicketPriority>() {
                                                    new TicketPriority() { Name = TTTicketPriority.Low.ToString()  },
                                                    new TicketPriority() { Name = TTTicketPriority.Medium.ToString() },
                                                    new TicketPriority() { Name = TTTicketPriority.High.ToString()},
                                                    new TicketPriority() { Name = TTTicketPriority.Urgent.ToString()},
                };
        ...
        //    //Get ticket type Ids
        //    int typeNewDev = context.TicketTypes.FirstOrDefault(p => p.Name == TTTicketType.NewDevelopment.ToString()).Id;
        //    int typeWorkTask = context.TicketTypes.FirstOrDefault(p => p.Name == TTTicketType.WorkTask.ToString()).Id;
        //    int typeDefect = context.TicketTypes.FirstOrDefault(p => p.Name == TTTicketType.Defect.ToString()).Id;
        //    int typeEnhancement = context.TicketTypes.FirstOrDefault(p => p.Name == TTTicketType.Enhancement.ToString()).Id;
        //    int typeChangeRequest = context.TicketTypes.FirstOrDefault(p => p.Name == TTTicketType.ChangeRequest.ToString()).Id;

        //    //Get ticket priority Ids
        //    int priorityLow = context.TicketPriorities.FirstOrDefault(p => p.Name == TTTicketPriority.Low.ToString()).Id;
        //    int priorityMedium = context.TicketPriorities.FirstOrDefault(p => p.Name == TTTicketPriority.Medium.ToString()).Id;
        //    int priorityHigh = context.TicketPriorities.FirstOrDefault(p => p.Name == TTTicketPriority.High.ToString()).Id;
        //    int priorityUrgent = context.TicketPriorities.FirstOrDefault(p => p.Name == TTTicketPriority.Urgent.ToString()).Id;

        //    //Get ticket status Ids
        //    int statusNew = context.TicketStatuses.FirstOrDefault(p => p.Name == TTTicketStatus.New.ToString()).Id;
        //    int statusDev = context.TicketStatuses.FirstOrDefault(p => p.Name == TTTicketStatus.Development.ToString()).Id;
        //    int statusTest = context.TicketStatuses.FirstOrDefault(p => p.Name == TTTicketStatus.Testing.ToString()).Id;
        //    int statusResolved = context.TicketStatuses.FirstOrDefault(p => p.Name == TTTicketStatus.Resolved.ToString()).Id;
