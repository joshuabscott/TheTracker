...
{
    public partial class _01_Add_TTUser_And_Models : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyFileData = table.Column<byte[]>(type: "bytea", nullable: true),
                    CompanyFileType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AvatarFileType = table.Column<string>(type: "text", nullable: true),
                    AvatarContentName = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectPriorityId = table.Column<string>(type: "text", nullable: true),
                    Archived = table.Column<bool>(type: "boolean", nullable: false),
                    ProjectFileData = table.Column<byte[]>(type: "bytea", nullable: true),
                    ProjectFileType = table.Column<string>(type: "text", nullable: true),
                    ImageContentType = table.Column<string>(type: "text", nullable: true),
                    ProjectPriorityId1 = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Projects_ProjectPriorities_ProjectPriorityId1",
                        column: x => x.ProjectPriorityId1,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTTUser", x => new { x.MembersId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_ProjectTTUser_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTTUser_Projects_ProjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificationTicket", x => new { x.NotificationsId, x.TicketsId });
                    table.ForeignKey(
                        name: "FK_NotificationTicket_Notifications_NotificationsId",
                        column: x => x.NotificationsId,
                        principalTable: "Notifications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificationTicket_Tickets_TicketsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketFileData = table.Column<byte[]>(type: "bytea", nullable: true),
                    TicketFileType = table.Column<string>(type: "text", nullable: true),
                    TicketFileName = table.Column<string>(type: "text", nullable: true),
                    TicketContentType = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificationTicket_TicketsId",
                table: "NotificationTicket",
                column: "TicketsId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Projects_ProjectPriorityId1",
                table: "Projects",
                column: "ProjectPriorityId1");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectTTUser_ProjectsId",
                table: "ProjectTTUser",
                column: "ProjectsId");
